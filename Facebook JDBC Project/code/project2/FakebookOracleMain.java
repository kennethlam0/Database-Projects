...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "lamken"; // replace with your uniqname
    private static String password = "youngtree516"; // replace with your Oracle password (default: eecsclass)
